...
if(NOT A2_MODULEPATH)
list(APPEND A2_MODULEPATH_DIRS ${A2_OUTPUT}/${A2_CATEGORY})
list(APPEND A2_MODULEPATH_DIRS ${A2_OUTPUT}/lib/${A2_CATEGORY})
list(APPEND A2_MODULEPATH_DIRS ${CMAKE_BINARY_DIR})
foreach(CATEGORY IN LISTS DEP_CATEGORIES)
	list(APPEND A2_MODULEPATH_DIRS ${A2_BASE}/${CATEGORY})
endforeach()
cmake_path(CONVERT "${A2_MODULEPATH_DIRS}" TO_NATIVE_PATH_LIST A2_MODULEPATH_RAW)
# Required on Windows
string(REPLACE ";" "\\;" A2_MODULEPATH "${A2_MODULEPATH_RAW}")
endif() # A2_MODULEPATH
message(STATUS "A2_MODULEPATH=${A2_MODULEPATH}")
